...
-- 初始化 5 个固定角色
INSERT IGNORE INTO sys_role (role_code, role_name, description, sort_order) VALUES
...
-- 初始化基础菜单
INSERT IGNORE INTO sys_menu (name, code, path, component, icon, sort_order, menu_type, parent_id, permission) VALUES
