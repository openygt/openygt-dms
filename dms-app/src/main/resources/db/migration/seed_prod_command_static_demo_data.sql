...
(100001, 'DEMO_GRP_SOAK', '浸泡/前处理组', 5, 15, 'ACTIVE', 'default', 0, NOW(, NULL),
(100002, 'DEMO_GRP_DECOCT', '煎煮执行组', 6, 12, 'ACTIVE', 'default', 0, NOW(, NULL),
(100003, 'DEMO_GRP_PACK', '包装后处理组', 6, 12, 'ACTIVE', 'default', 0, NOW(, NULL);
...
(100003, 100005, 100005, 'DECOCT', 3, 'OVERTIME', '煎煮已超时30分钟', 'SMS,APP,PHONE', 'ADMIN,OPERATOR', 1, 'admin', NOW(, NULL),
...
(100006, 100011, 100011, 'QC', 2, 'QUALITY', '质检不合格', 'APP', 'QC,OPERATOR', 1, 'qc01', NOW(, NULL),
(100007, 100012, 100012, 'COMPLETE', 0, 'INFO', '任务已完成', 'APP', 'OPERATOR', 1, 'system', NOW(, NULL);
...
(NULL, 'SIM-DECOCT-02', 1, 'ONLINE', 'SOAKING', 65.50, 70.00, 3, 0.00, 'RX202605060001', '标准煎药方案', 1, '张师傅', 45, 1800, '', '', NOW(, NULL),
(NULL, 'PDA_001', 1, 'ONLINE', 'IDLE', 25.00, 0.00, 0, 0.00, '', '', 0, '', 0, 0, '', '', NOW(, NULL),
(NULL, 'DECOCT_001', 1, 'ONLINE', 'FIRST_DECOCTING', 98.50, 100.00, 2, 0.15, 'RX202605060003', '标准煎药方案', 3, '李师傅', 65, 1200, '', '', NOW(, NULL),
(NULL, 'SIM-DECOCT-01', 1, 'ONLINE', 'SECOND_DECOCTING', 96.00, 100.00, 2, 0.12, 'RX202605060004', '标准煎药方案', 4, '王师傅', 70, 900, '', '', NOW(, NULL),
(NULL, 'SIM-DECOCT-TCP-01', 1, 'ONLINE', 'BUSY', 88.00, 90.00, 2, 0.10, 'RX202605060005', '标准煎药方案', 5, '刘师傅', 55, 1500, '', '', NOW(, NULL),
(NULL, 'SIM-WRAP-01', 2, 'ONLINE', 'IDLE', 30.00, 0.00, 0, 0.00, '', '', 0, '', 0, 0, '', '', NOW(, NULL),
(NULL, 'PACK_001', 2, 'OFFLINE', 'OFFLINE', 0.00, 0.00, 0, 0.00, '', '', 0, '', 0, 0, '', '通信超时', NOW(, NULL),
(NULL, 'PACK_002', 2, 'ONLINE', 'FAULT', 0.00, 0.00, 0, 0.00, '', '', 0, '', 0, 0, '', 'E101-温度传感器故障', NOW(, NULL),
(NULL, 'LBL_PRN_001', 3, 'ONLINE', 'MAINTENANCE', 0.00, 0.00, 0, 0.00, '', '', 0, '', 0, 0, '', '', NOW(, NULL),
(NULL, 'LASER_PRN_001', 4, 'ONLINE', 'READY', 28.00, 0.00, 0, 0.00, '', '', 0, '', 0, 0, '', '', NOW(, NULL);
...
(NULL, 100001, '浸泡完成提醒', '{"stage":"SOAK_DONE","durationMin":30}', 'NOTIFY', '[5,6]', 1, 'default', 0, NOW(, NULL),
(NULL, 100002, '煎煮超时告警', '{"stage":"DECOCTING","durationMin":60}', 'ALARM', '[1,2,3,4,774]', 1, 'default', 0, NOW(, NULL),
(NULL, 100003, '包装完成自动打印', '{"stage":"PACK_DONE","autoPrint":true}', 'COMMAND', '[12,15]', 1, 'default', 0, NOW(, NULL);
...
(NULL, 1, 'MAINTENANCE', '清洗加热管，检查温控器', NULL, 120.00, 1, '2026-05-01', '2026-05-02', 'COMPLETED', 'default', 0, NOW(, NULL),
(NULL, 2, 'REPAIR', '更换水位传感器', '传感器组件', 85.00, 2, '2026-05-03', '2026-05-03', 'COMPLETED', 'default', 0, NOW(, NULL),
(NULL, 3, 'MAINTENANCE', '全面清洗与校准', NULL, 200.00, 3, '2026-05-05', NULL, 'PENDING', 'default', 0, NOW(, NULL),
(NULL, 774, 'INSPECTION', '月度巡检，固件升级', NULL, 0.00, 4, '2026-05-06', NULL, 'PENDING', 'default', 0, NOW(, NULL),
(NULL, 5, 'REPAIR', '更换传送带', '传送带组件', 350.00, 5, '2026-05-04', '2026-05-04', 'COMPLETED', 'default', 0, NOW(, NULL),
(NULL, 12, 'MAINTENANCE', '打印头清洁，导轨润滑', NULL, 80.00, 6, '2026-05-02', '2026-05-02', 'COMPLETED', 'default', 0, NOW(, NULL);
