  ...
  <view class="container">
    ...
    <view class="header">
      <view class="greeting-area">
        <text class="greeting">{{ greeting }}，{{ userInfo.userName || userInfo.userCode || '操作员' }}</text>
        <text class="device">设备：{{ userInfo.deviceCode || '未绑定' }}</text>
      </view>
    </view>

    <!-- 主扫码区 -->
    <view class="main-scan" @click="goScan">
    ...
    <view class="sub-actions">
      ...
      <view class="sub-btn primary" @click="goReprint">重打印</view>
    </view>
    ...
    <view class="recent-section" v-if="recentTasks.length > 0">
      ...
      <view class="recent-list">
        <view class="recent-item" v-for="item in recentTasks" :key="item.taskId" @click="goTaskDetail(item.barcode)">
