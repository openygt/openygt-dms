<template>
  <view class="container">
    ...
    <view class="sign-area">
      ...
      <canvas canvas-id="signCanvas" class="sign-canvas" @touchstart="startDraw" @touchmove="draw" @touchend="endDraw" />
    </view>
    ...
    <view class="actions">
      ...
      <button class="confirm-btn" :disabled="!hasSigned || loading" :loading="loading" @click="handleConfirm">确认签字</button>
    </view>
  </view>
</template>
