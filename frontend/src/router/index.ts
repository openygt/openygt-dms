  ...
  routes: [
    { path: '/login', name: 'Login', component: () => import('@/views/LoginView.vue') },
    {
      ...
      children: [
        ...
        { path: 'device-command', name: 'DeviceCommand', component: () => import('@/views/eq/DeviceCommandView.vue'), meta: { title: '远程急停', perm: 'eq:device:emergency' } },
        ...
        { path: 'device-group-manage', name: 'DeviceGroupManage', component: () => import('@/views/eq/DeviceGroupManageView.vue'), meta: { title: '设备分组', perm: 'eq:group:view' } },
      ]
    },
