  ...
  routes: [
    { path: '/login', name: 'Login', component: () => import('@/views/LoginView.vue') },
    {
      ...
      children: [
        ...
        { path: 'task-assignment', name: 'TaskAssignment', component: () => import('@/views/prod/TaskAssignmentView.vue'), meta: { title: '任务调度中心' } },
        { path: 'task-rollback', name: 'TaskRollback', component: () => import('@/views/prod/TaskRollbackView.vue'), meta: { title: '异常回退处理' } },
        { path: 'patient-query', name: 'PatientQuery', component: () => import('@/views/patient/PatientQueryView.vue'), meta: { title: '患者进度查询' } },
        { path: 'shelf-manage', name: 'ShelfManage', component: () => import('@/views/warehouse/ShelfManageView.vue'), meta: { title: '成品货架管理' } },
        { path: 'voice-setting', name: 'VoiceSetting', component: () => import('@/views/pda/VoiceSettingView.vue'), meta: { title: '语音播报配置' } },
        { path: 'employee-barcode', name: 'EmployeeBarcode', component: () => import('@/views/system/EmployeeBarcodeView.vue'), meta: { title: '员工身份条码' } },
