...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (uri.startsWith("/api/v1/auth/") || uri.startsWith("/api/v1/sys/auth/") || uri.startsWith("/api/v1/rbac/auth/") || uri.startsWith("/api/v1/pda/auth/login") || uri.startsWith("/api/v1/pda/auth/scan-login") || uri.startsWith("/api/v1/pda/config/version") || uri.startsWith("/error")) {
            return true;
        }
